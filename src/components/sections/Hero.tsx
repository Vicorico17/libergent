...
export function Hero() {
  ...
  return (
    <section
      className="pt-[90px] min-h-screen flex items-center"
      style={{ background: CREAM, fontFamily: MONO }}
    >
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-16 lg:py-20">
        ...
        <div className="lg:col-span-5 flex flex-col gap-8 lg:pr-8">
          ...
          <div className="mt-4 relative group w-full max-w-xl">
            ...
            >
              ...
              <button
                type="submit"
                className="font-bold text-[12px] tracking-widest px-8 py-4 transition-colors whitespace-nowrap uppercase flex items-center gap-3 shrink-0"
        ...
        <div className="lg:col-span-7 w-full h-full relative group">
          <div
            className="flex flex-col w-full min-h-[550px] overflow-hidden transition-all duration-300 relative z-10 cursor-default"
            style={{
